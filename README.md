...
Fork of jasmine-node v1.14.3 which includes a patch for getting junit reports working and also specifies jasmine-reporters@<2.0.0 to avoid [Issue #63](https://github.com/larrymyers/jasmine-reporters/issues/63) - Adrian
